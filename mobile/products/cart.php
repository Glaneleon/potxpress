...
if($resultOfQueryFind -> num_rows > 0){
    ...
    if($updateQuantity < $productStock){
        ...
        echo json_encode(array("exceed" => true));
    }   
    ...
    $sqlQuery = "INSERT INTO add_to_cart(product_id, user_id, product_quantity, product_stock, product_price, product_price_total, product_color) VALUES ('".$product_id."', '".$user_id."', '".$product_quantity."', '".$product_stock."', '".$product_price."', '".$product_price_total."', '".$product_color."')";
