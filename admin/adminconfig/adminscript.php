...
<script>
    $(document).ready(function() {
        $('#order_notifications_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "./adminconfig/getall_notifs.php",
                type: "POST"
            },
            columns: [
                {
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.notification').click(function() {
            ...
            $.ajax({
                url: './adminconfig/read_notifs.php',
                type: 'POST',
                data: {
...
<script>
    $(document).ready(function() {
        $('#receiptsTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "./adminconfig/getall_receipts.php",
                type: "POST"
            },
            columns: [{
                    title: "Order ID",
...
<script>
    $(document).ready(function() {
        ...
        $('#paymentsLogs').DataTable();
        $('#accountstable').DataTable();
        $('#accesslogs').DataTable();
        $('#addproductlogs').DataTable();
        $('#addproductstocklogs').DataTable();
        $('#deleteproductlogs').DataTable();
        $('#editproductlogs').DataTable();
    });
</script>
